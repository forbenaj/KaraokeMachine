...
LYRICS_TIMING_METHODS = {DEFAULT_LYRICS_TIMING_METHOD, "silero-vad"}
DEFAULT_LYRICS_TIMING_SOURCE = "original"
LEGACY_LYRICS_TIMING_SOURCE = "vocal-stem"
LYRICS_TIMING_SOURCES = {DEFAULT_LYRICS_TIMING_SOURCE, LEGACY_LYRICS_TIMING_SOURCE}
DEFAULT_TIMING_PIPELINE_SCHEDULE = "stems-first"
TIMING_PIPELINE_SCHEDULES = {DEFAULT_TIMING_PIPELINE_SCHEDULE, "lyrics-first", "parallel"}
LYRICS_TIMING_VERSION = 6
