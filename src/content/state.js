...
const FAILURE_NOTIFICATION_ID = "dkaraoke-failure-notification";
...
const I18N = {
  en: {
    ...
    method: "Method",
    currentCtc: "CTC forced alignment",
  ...
  ja: {
    ...
    controlsAria: "カラオケ再生の操作",
    lyricsEditorAria: "カラオケ歌詞エディター",
    controlsSectionAria: "カラオケ操作",
    separatedTracksAria: "分離音声トラック",
    toggleModeAria: "カラオケモードのオン/オフ",
    openModeTitle: "カラオケモードを開く",
    closeModeTitle: "カラオケモードを閉じる",
    ...
    lyrics: "歌詞",
    lyricsUpper: "歌詞",
    lyricsInitialStatus: "LRCLIBで検索するか歌詞を入力し、タイミングを抽出してください。",
    searchLrclib: "LRCLIBで検索",
    searchingLrclib: "LRCLIBを検索中...",
    extractTimings: "タイミング抽出",
    extractingTimings: "タイミングを抽出中...",
    lyricsPlaceholder: "LRCLIBの歌詞がここに表示されます。直接貼り付けたり入力したりもできます。",
    lyricsStyle: "歌詞スタイル",
    styleClassic: "クラシック",
    styleArcade: "アーケード",
    styleSimple: "シンプル",
    ...
    settings: "設定",
    settingsAria: "カラオケマシンの設定",
    close: "閉じる",
    language: "言語",
    latencyCompensation: "遅延補正 (ms)",
    lyricsTimingOffset: "歌詞のタイミング補正 (ms)",
    timingExtraction: "タイミング抽出",
    method: "方式",
    currentCtc: "CTC強制アライメント",
    sileroVad: "Silero VAD",
    audioSource: "音声ソース",
    originalAudio: "元音声",
    vocalStem: "ボーカルステム",
    pressMeOrder: "準備時の処理順",
    stemsFirst: "音声を先に準備",
    lyricsFirst: "歌詞を先に処理",
    runTogether: "同時に実行",
    defaultState: "デフォルト状態",
    keepAcrossSongs: "曲が変わっても保持",
    alwaysResetTo: "常に次の状態に戻す:",
    diagnostics: "診断",
    debugConsole: "デバッグコンソール",
    debugLogAria: "カラオケマシンのデバッグログ",
    debugTitle: "カラオケマシンのデバッグ",
    liveProcessTrace: "リアルタイム処理ログ",
    queue: "キュー",
    queueAria: "カラオケマシンの処理キュー",
    ...
    pause: "一時停止中",
    readyBang: "準備完了!",
    pressMeTitle: "押すとこの曲の準備を開始します。",
    preparationInProgress: "この曲を準備中です。",
    alreadyPrepared: "この曲は準備済みです。",
    enableStemTitle: "{stem}をオンにする",
    disableStemTitle: "{stem}をオフにする",
    prepareForAudioTitle: "分離音声を使うには、この曲を準備してください。",
    hideLyricsTitle: "同期歌詞を非表示にする",
    showLyricsTitle: "同期歌詞を表示する",
    addLyricsTitle: "歌詞を追加または読み込んでから、曲を準備してください。",
    prepareBeforeSwitching: "音声を切り替えるには、先にこの曲を準備してください。",
    youtubeNotReady: "YouTubeプレーヤーの準備がまだできていません。",
    usingOriginalAudio: "YouTubeの元音声を再生中です。",
    usingStem: "{stem}を同期再生中です。",
    bothStemsOff: "インストとボーカルがどちらもオフです。",
    separatedCouldNotStartRetry: "分離音声を再生できませんでした。インストまたはボーカルを切り替えて再試行してください。",
    separatedReadyToggle: "分離音声の準備ができました。インストまたはボーカルを切り替えると、元音声から切り替わります。",
    separatedInterrupted: "分離音声が中断されました。YouTubeの元音声を使用します。",
    separatedEndedEarly: "分離音声が途中で終了しました。YouTubeの元音声を使用します。",
    separatedAudioReadySync: "分離音声の準備完了。インストを同期しています...",
    loadingSeparatedAudioPage: "ページに分離音声を読み込み中...",
    separatedAudioLoadedPage: "ページに分離音声を読み込みました。",
    stemTrackFailedLoad: "{stem}を読み込めませんでした。",
    stemTrackBackendFailed: "バックエンドから{stem}を読み込めませんでした。",
    connecting: "接続中...",
    connectingDownloader: "ダウンローダーに接続中...",
    couldNotStartDownloader: "ダウンローダーを開始できませんでした。",
    couldNotStartTimingKaraokize: "曲の準備を開始できなかったため、歌詞のタイミング抽出を開始できませんでした。",
    cacheChecking: "キャッシュを確認中...",
    savedChecking: "保存済みのカラオケ結果を確認中...",
    cacheCheckFailedStillAvailable: "保存済みの結果を確認できませんでした。カラオケマシンは引き続き使用できます。",
    savedLyricsSyncedReady: "保存済みの同期歌詞があります。",
    savedLyricsTextReady: "保存済みの歌詞テキストがあります。表示するにはタイミングを抽出してください。",
    cachedInstrumentalReady: "キャッシュ済みのインストを使用できます。",
    savedLyricsReadyPrepareAudio: "保存済みの歌詞があります。音声を準備してください。",
    prepareAudio: "音声を準備してください。",
    lyricsTimingsExtracted: "歌詞のタイミングを抽出しました。",
    couldNotExtractTimings: "歌詞のタイミングを抽出できませんでした。",
    lrclibLyricsLoaded: "LRCLIBの歌詞を読み込みました。",
    lrclibNoReliableMatch: "LRCLIBで適切な候補が見つかりませんでした。手動で歌詞を入力できます。",
    lrclibSearchFailedManual: "LRCLIB検索に失敗しました。手動で歌詞を入力できます。",
    lyricsAvailableRefining: "歌詞が見つかりました。分離後にタイミングを調整します...",
    backendMissingTracks: "バックエンドから両方の分離音声トラックが返されませんでした。",
    cachedSeparatedReady: "キャッシュ済みの分離音声を使用できます。",
    cachedStemsLoading: "キャッシュ済みの分離音声があります。同期音声を読み込み中...",
    separatedAudioReady: "分離音声の準備完了。",
    stemsLoading: "分離音声の準備完了。同期音声を読み込み中...",
    stemsReady: "分離音声の準備完了。",
    checkedSavedResults: "保存済みカラオケ結果を確認しました。",
    separatingRoFormer: "RoFormerでインストとボーカルを分離中...",
    preparingRoFormer: "RoFormer用に音声を準備中...",
    roformerSeparating: "RoFormerでボーカルを分離中...",
    youtubeSignInRetry: "YouTubeがログインを要求しました。ChromeのCookieで再試行中...",
    downloadingSourceAudio: "ソース音声をダウンロード中...",
    downloadingOriginalTiming: "歌詞のタイミング抽出用に元音声をダウンロード中...",
    aligningLyrics: "入力された歌詞をボーカルに同期中...",
    detectingVocalActivity: "Silero VADでボーカル区間を検出中...",
    synchronizedLyricsReady: "同期歌詞の準備ができました。",
    lyricsLoadedNoTimings: "歌詞を読み込みました。タイミングはまだありません。",
    downloadFailed: "ダウンロードに失敗しました。",
    processingLyrics: "歌詞を処理中...",
    enterLyricsBeforeExtracting: "タイミングを抽出する前に、歌詞を入力するか検索してください。",
    startingTiming: "歌詞のタイミング抽出を開始中...",
    extractingWith: "{source}を使って{method}でタイミングを抽出中...",
    queuedTimingWithPrepare: "曲の準備と一緒に、歌詞のタイミング抽出をキューに追加しました...",
    willExtractTimings: "{schedule}{method}でタイミングを抽出します...",
    willFindThenExtract: "歌詞を検索してから、{schedule}{method}でタイミングを抽出します...",
    ...
    idle: "待機中",
    event: "イベント",
    phaseFinished: "{phase}が完了しました。",
    timingMethodCtc: "CTC強制アライメント",
    timingMethodSilero: "Silero VAD",
    timingSourceOriginal: "元の音声",
    timingSourceVocal: "ボーカルステム",
    timingScheduleStemsFirst: "音声分離後に",
    timingScheduleLyricsFirst: "音声分離前に",
    timingScheduleParallel: "音声分離と同時に",
    monitorDownloading: "ダウンロード中...",
    monitorExtracting: "音声処理中...",
    monitorQueued: "待機中...",
  },
  es: {
    appName: APP_NAME,
    ...
    method: "Método",
    currentCtc: "Alineación forzada CTC",
    sileroVad: "Silero VAD",
